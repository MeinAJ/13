...
package com.aj.unique.aop;

import com.aj.unique.annotations.UniqueValue;
import com.aj.unique.dao.UniqueRecordDao;
...
public class UniqueAspect {
    ...
    @Pointcut("@annotation(com.aj.unique.annotations.Unique)")
